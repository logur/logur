// Package grpclog provides a gRPC logger V2 compatible logger.
package grpclog
...
// Logger is a gRPC logger V2 compatible logger.
type Logger struct {
	logger       logur.Logger
	levelEnabler logur.LevelEnabler
}

// New returns a new gRPC logger V2 compatible logger.
